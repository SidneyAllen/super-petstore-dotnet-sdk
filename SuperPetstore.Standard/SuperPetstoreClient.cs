// <copyright file="SuperPetstoreClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace SuperPetstore.Standard
{
    using System;
    ...
    using SuperPetstore.Standard.Authentication;
    using SuperPetstore.Standard.Controllers;
    ...
    /// </summary>
    public sealed class SuperPetstoreClient : IConfiguration
    {
        ...
        {
            {
                ...
                {
                    { Server.Default, "https://api.mega-petstore.com" },
                }
            },
        };
        ...
        /// <summary>
        /// Creates an object of the SuperPetstoreClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> SuperPetstoreClient.</returns>
        internal static SuperPetstoreClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("SUPER_PETSTORE_STANDARD_ENVIRONMENT");
            string accessToken = System.Environment.GetEnvironmentVariable("SUPER_PETSTORE_STANDARD_ACCESS_TOKEN");
        ...
        {
            private Environment environment = SuperPetstore.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>SuperPetstoreClient.</returns>
            public SuperPetstoreClient Build()
            {

                return new SuperPetstoreClient(
                    environment,
                    accessToken,
                    httpCallBack,
